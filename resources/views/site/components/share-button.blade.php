@php
    ...
    $shareLinks = [
        'bluesky'  => 'https://bsky.app/intent/compose?text=' . rawurlencode($shareTitle . ' ' . $shareUrl),
        ...
        'threads'  => 'https://www.threads.net/intent/post?text=' . rawurlencode($shareTitle . ' ' . $shareUrl),
        'twitter'  => 'https://twitter.com/intent/tweet?text=' . rawurlencode($shareTitle) . '&url=' . rawurlencode($shareUrl),
    ];
@endphp
...
<div class="article-share" id="articleShare" data-share-url="{{ $shareUrl }}" data-share-title="{{ $shareTitle }}">
    ...
    <div class="share-menu" id="shareMenu" role="menu" hidden>
        ...
        <a class="share-menu-item" role="menuitem" href="{{ $shareLinks['bluesky'] }}" target="_blank" rel="noopener" data-share="bluesky" data-track="cta_click" data-track-label="Share Bluesky">
        ...
        <a class="share-menu-item" role="menuitem" href="{{ $shareLinks['facebook'] }}" target="_blank" rel="noopener" data-share="facebook" data-track="cta_click" data-track-label="Share Facebook">
        ...
        <a class="share-menu-item" role="menuitem" href="{{ $shareLinks['linkedin'] }}" target="_blank" rel="noopener" data-share="linkedin" data-track="cta_click" data-track-label="Share LinkedIn">
        ...
        <a class="share-menu-item" role="menuitem" href="{{ $shareLinks['threads'] }}" target="_blank" rel="noopener" data-share="threads" data-track="cta_click" data-track-label="Share Threads">
        ...
        <a class="share-menu-item" role="menuitem" href="{{ $shareLinks['twitter'] }}" target="_blank" rel="noopener" data-share="twitter" data-track="cta_click" data-track-label="Share X">
