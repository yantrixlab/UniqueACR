...
<head>
    ...
    {{-- Primary SEO --}}
    <title>@yield('title', 'AC Repair Kolkata | AC Service, Installation & Maintenance – Unique Aircon')</title>
    ...
    <meta name="author" content="Unique Aircon">
    ...
    <meta property="og:site_name" content="Unique Aircon">
    <meta property="og:title" content="@yield('og_title', 'AC Repair Kolkata | AC Service, Installation & Maintenance – Unique Aircon')">
    ...
    <meta property="og:image:alt" content="Unique Aircon – AC Repair & Servicing in Kolkata">
    <meta property="og:locale" content="en_IN">

    {{-- Twitter Card --}}
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="@yield('og_title', 'AC Repair Kolkata | AC Service, Installation & Maintenance – Unique Aircon')">
    ...
    <meta name="apple-mobile-web-app-title" content="Unique Aircon">
...
<header class="topbar">
    <div class="container nav-wrap">
        ...
        <div class="nav-actions">
            <a class="quote-btn" href="{{ route('contact') }}" data-track="cta_click" data-track-label="Get Quote - Header">Get Quote</a>
        </div>
    </div>
</header>
...
<aside class="mob-side-panel" id="mobSidePanel" aria-label="Mobile navigation" aria-hidden="true">
    ...
    <div class="mob-panel-footer">
        <a class="quote-btn" href="{{ route('contact') }}" data-track="cta_click" data-track-label="Get Quote - Mobile Menu">Get Quote</a>
    </div>
</aside>
...
// GA4 click tracking for any element with data-track="<event_name>"
document.addEventListener('click', function (e) {
    var el = e.target.closest('[data-track]');
    if (!el || typeof gtag !== 'function') return;
    gtag('event', el.getAttribute('data-track'), {
        label: el.getAttribute('data-track-label') || el.textContent.trim().slice(0, 100),
        category: el.getAttribute('data-track-category') || 'engagement',
...
<div class="floating-stack">
    ...
    <div class="float-wrap float-wrap-call">
        ...
        <a href="tel:+918346904100" class="float-btn float-call" aria-label="Call now" data-track="cta_click" data-track-label="Floating Call Button">
    ...
    <div class="float-wrap float-wrap-wa">
        <span class="float-ripple"></span>
        <span class="float-ripple ripple-delay"></span>
        <a href="https://wa.me/918346904100" target="_blank" rel="noopener" class="float-btn float-wa" aria-label="WhatsApp" data-track="cta_click" data-track-label="Floating WhatsApp Button">
...
<footer class="footer">
    ...
    <div class="copyright">© {{ date('Y') }} Unique Aircon. All rights reserved.</div>
</footer>
