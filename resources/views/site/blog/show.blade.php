...
<script type="application/ld+json">{!! json_encode([
    ...
    'author'           => ['@type' => 'Organization', 'name' => 'Unique Air Conditioning & Refrigeration'],
    'publisher'        => [
        '@type' => 'Organization',
